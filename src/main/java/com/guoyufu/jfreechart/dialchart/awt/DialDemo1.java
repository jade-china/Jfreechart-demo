package com.guoyufu.jfreechart.dialchart.awt;
...
public class DialDemo1 extends JFrame {
	...
	private static final long serialVersionUID = 2616513711261691110L;

	static class DemoPanel extends JPanel implements ChangeListener {

		private static final long serialVersionUID = -4946518120591199607L;
		
		JSlider slider;
		DefaultValueDataset dataset;

		public static JFreeChart createStandardDialChart(String s, String s1, ValueDataset valuedataset, double d,
