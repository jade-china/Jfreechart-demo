package com.guoyufu.jfreechart.spiderwebChart.awt;
...
public class SpiderWebChartDemo extends ApplicationFrame {

	private static final long serialVersionUID = 4621207896182488590L;

	public SpiderWebChartDemo(String s) {
		super(s);
	...
	public static void main(String args[]) {
		SpiderWebChartDemo spiderwebchartdemo1 = new SpiderWebChartDemo("SpiderWebChartDemo1");
